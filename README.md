...
| `msrv-effective`       | <p>The highest <code>rust-version</code> across every package in the resolved dependency graph, or an empty string. Use this, not <code>msrv</code>, to choose a toolchain: the two differ whenever a dependency outruns the crate's own declared floor.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `msrv-source`          | <p>Where <code>msrv</code> was read from — <code>cargo-toml</code>, <code>workspace-inherit</code>, or <code>none</code>.</p>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
